...
import AddProject from "@/components/sub-components/AddProject";
import AddSkill from "@/components/sub-components/AddSkill";
import AddTimeline from "@/components/sub-components/AddTimeline";
import AddSoftware from "@/components/sub-components/AddSoftware";
import Messages from "@/components/sub-components/Messages";
import ManageAccount from "@/components/sub-components/ManageAccount";
    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          <Link
            to="/"
            className="group flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-full bg-black text-white"
          >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  onClick={() => setActive("Manage Account")}
                >
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        ...
        <div className="flex items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5">
          <img
            ...
            alt="avatar"
            className="w-16 h-16 rounded-full max-[900px]:hidden"
          />
          <h1 className="text-3xl max-[900px]:text-2xl font-normal">
